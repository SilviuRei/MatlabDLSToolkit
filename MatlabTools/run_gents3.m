function run_gents3(nume, dmin, pas, dmax, theta, lambda, indref, tcelsius, fs, nf, nt, opt)
%
...
for diam=dmin:pas:dmax
    i=i+1;
    d(i)=diam;
    [t,x,a0(i),a1(i)]=gents3(nume, diam, theta, lambda, indref, tcelsius, fs, nf, nt, opt);
end
rez=[d',a0',a1'];
