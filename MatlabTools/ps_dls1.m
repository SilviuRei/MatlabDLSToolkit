function []=ps_dls1(nume,frecv,tip,opt)
%
...
%       temp_abs    cum ii spune numele
%       angle este unghiul la care a fost facuta inregistrarea, in
%       RADIANI!!!
%       opt este un parametru de control pentru iesiri
%           Daca opt=0 nu salveaza nimic
%                opt=1 salveaza fisierul cu fr si PS
%                opt=2 salveaza graficul PSD in format fig
%
%
