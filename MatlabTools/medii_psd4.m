function [medii]=medii_psd4(nume,extensie,ngrup,extgraf,optprel, optgraf)
%
...
%   Fata de versiunea 5 face si o scalare a.i. prima valoare sa fie 10, mai
%   usor pentru fitare, cu plaja mica pentru a0 si poate mai usor pt NN.
%
%   daca optprel=1 salveaza fisierul nenormalizat 
%   daca optprel=2 salveaza fisierul normalizat (prima valoare pe 10)
%
...
numefisout=[nume,'-',int2str(ngrup),'-medgr',strnorm,'.',extensie]
