function [diam,a0,a1,chi2min,exitflag]=chi2dlslsq2(nume,dmic,dist,indref,lambda,tcelsius,a0start,a0min,a0max,a1start,a1min,a1max,control,tip);
% 
...
%
% Apelare:
% [diam,a0,a1,chi2min,exitflag]=chi2dlslsq2(nume,dmic,dist,indref,lambda,tcelsius,a0start,a0min,a0max,a1start,a1min,a1max,control,tip);
%
t0=clock;   %marcheaza inceputul executiei
disp(' ');
disp(['Fitez fisierul: ',nume])
nume_inn=[nume,'.fps'];
tmp=load(nume_inn);
[n,l]=size(tmp);
...
% change some options
%
options=optimset('MaxFunEvals',15000,'MaxIter',5000,'TolX',1.e-8,'TolFun',1.e-18);
%options=optimset('MaxFunEvals',35000,'MaxIter',10000,'TolX',1.e-8,'TolFun',1.e-10);
%
%keyboard;
