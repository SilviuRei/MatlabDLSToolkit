...
%	Example:
%		[d,a0,a1, deltaT] = batchDLSFitFindA0A1Size (x, 5:5:30, 1, 6, 1,16000,...
...
for i=index1:istep:index2
    ...
    namePlotTs=['d-',num2str(din(i)),'-f-',num2str(fs),...
...
saveNameA0=['dlsFitFindA0A1D_a0_d-' num2str(din(index1)) '-' num2str(din(index2)) '-' num2str(istep) '-' ...
    'lambda-' num2str(lambda) '-'...
    'temp-' num2str(tcelsius) '-'...
    'theta-' num2str(theta) '-'...
    'indref-' num2str(indref) '-'...
    'eta-' num2str(eta) '-'... 
    '_f-' num2str(fs),'.txt'];
saveNameA1=['dlsFitFindA0A1D_a1_d-' num2str(din(index1)) '-' num2str(din(index2)) '-' num2str(istep) '-' ...
    'lambda-' num2str(lambda) '-'...
    'temp-' num2str(tcelsius) '-'...
    'theta-' num2str(theta) '-'...
    'indref-' num2str(indref) '-'...
    'eta-' num2str(eta) '-'... 
    '_f-' num2str(fs),'.txt'];
saveNameD=['dlsFitFindA0A1D_d_d-' num2str(din(index1)) '-' num2str(din(index2)) '-' num2str(istep) '-' ... '-' ...
    'lambda-' num2str(lambda) '-'...
    'temp-' num2str(tcelsius) '-'...
    'theta-' num2str(theta) '-'...
    'indref-' num2str(indref) '-'...
    'eta-' num2str(eta) '-'... 
    '_f-' num2str(fs),'.txt'];
saveNameDeltaT=['dlsFitFindA0A1D_deltat-' num2str(din(index1)) '-' num2str(din(index2)) '-' num2str(istep) '-' ... '-' ...
    'lambda-' num2str(lambda) '-'...
    'temp-' num2str(tcelsius) '-'...
    'theta-' num2str(theta) '-'...
    'indref-' num2str(indref) '-'...
