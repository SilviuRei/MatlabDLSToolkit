...
saveNameA1=['batchDlsFitFindA0A1D_a1_d-' num2str(d(index1)) '-' num2str(d(index2)) '-' num2str(istep) '-' ...
    ...
    'eta-' num2str(eta) '-'... 
    '_f-' num2str(fs),'.txt'];
saveNameD=['batchDlsFitFindA0A1D_d_d-' num2str(d(index1)) '-' num2str(d(index2)) '-' num2str(istep) '-' ... '-' ...
    'lambda-' num2str(lambda) '-'...
    'temp-' num2str(tcelsius) '-'...
    'theta-' num2str(theta) '-'...
    'indref-' num2str(indref) '-'...
    'eta-' num2str(eta) '-'... 
    '_f-' num2str(fs),'.txt'];
saveNameDeltaT=['batchDlsFitFindA0A1D_d_deltat-' num2str(d(index1)) '-' num2str(d(index2)) '-' num2str(istep) '-' ... '-' ...
    'lambda-' num2str(lambda) '-'...
    'temp-' num2str(tcelsius) '-'...
    'theta-' num2str(theta) '-'...
    'indref-' num2str(indref) '-'...
