...
[acf,lags]=run_analizor_autocor_2(tsName,mTs,autocorrLags,fs,'png',indsave,...
...
fileNameFitNN=['dlsAutocorrNNTrainAndFitMem_dFitN_d-' num2str(dMin) '-' num2str(dStep) '-' num2str(dMax) '-' ...
...
fileNameAcf=['dlsAutocorrNNTrainAndFitMem_acf_d-' num2str(dMin) '-' num2str(dMax) '-' num2str(dStep) '-' ...
        'autocorrLags-' num2str(autocorrLags) '-'...
        'nnHidden-' num2str(nnHidden) '-'...
        '_f-' num2str(fs) '.txt'];
...
fileNameDeltaT=['dlsAutocorrNNTrainAndFitMem_dFitN_deltat-' num2str(dMin) '-' num2str(dMax) '-' num2str(dStep) '-' ...
        'autocorrLags-' num2str(autocorrLags) '-'...
        'nnHidden-' num2str(nnHidden) '-'...
        '_f-' num2str(fs) '.txt'];
