function [d,a0,a1,roF] = batchDLSFindA0A1RollOffFrequency_Size (m, bS, eS, sS, index1, index2, istep, frequency, theta, lambda, indref, eta, tcelsius,a0start, a0min, a0max, a1start, a1min, a1max, deltaFit, figType, dispMode, cleanMode)
%-------------------------------------------------------------------------------
% Version 20171119, Silviu Rei
% function [roF] = batchDLSFindA0A1RollOffFrequency_Size (a0, a1, d, index1, index2, istep, frequency, deltaFit, figType, dispMode)
...
%	Example:
%		[d,a0,a1,roF] = batchDLSFindA0A1RollOffFrequency_Size (x, 5, 30, 5, 1, 6, 1, 16000, theta, lambda, indref, eta, tcelsius,a0start, a0min, a0max, a1start, a1min, a1max, 20, 'png', 0, 1)
%-------------------------------------------------------------------------------
dm = bS:sS:eS;
