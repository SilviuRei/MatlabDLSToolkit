function [roF] = dlsRollOffFrequency (pSize,lambda,tcelsius,theta,indref,...
    eta, a0, a1, frequency, deltaFit, figType, dispMode)
%--------------------------------------------------------------------------
...
figureName1=['plot_dlsRoF_ps_d-' num2str(pSize) '-' ...
...
figureName2=['plot_dlsRoF_loglogps_d-' num2str(pSize) '-'...
    'lambda-' num2str(lambda) '-'...
    'temp-' num2str(tcelsius) '-'...
    'theta-' num2str(theta) '-'...
    'indref-' num2str(indref) '-'...
